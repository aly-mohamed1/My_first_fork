...
$recipes = [
    ...
    [
        ...
        "instructions" => ["In a pot, simmer green curry paste in coconut milk.", "Add chicken, fish sauce, and sugar. Cook until chicken is tender.", "Stir in sliced eggplant and bell peppers. Simmer until vegetables are cooked.", "Garnish with fresh basil leaves.", "Serve hot over jasmine rice."],
        "prepTimeMinutes" => 20,
        "cookTimeMinutes" => 30,
        "servings" => 4,
        "difficulty" => "Medium",
    ...
    [
        ...
        "instructions" => ["In a blender, combine diced mango, yogurt, milk, honey, and cardamom powder.", "Blend until smooth and creamy.", "Add ice cubes and blend again until the lassi is chilled.", "Pour into glasses and garnish with a sprinkle of cardamom."],
        "prepTimeMinutes" => 10,
        "cookTimeMinutes" => 0,
        "servings" => 2,
        "difficulty" => "Easy",
    ...
    [
        ...
        "instructions" => ["In a bowl, whip heavy cream until stiff peaks form.", "In another bowl, mix mascarpone cheese and sugar until smooth.", "Gently fold the whipped cream into the mascarpone mixture.", "Dip ladyfinger cookies into brewed espresso and layer them in a serving dish.", "Spread a layer of the mascarpone mixture over the cookies.", "Repeat layers and finish with a dusting of cocoa powder."],
        "prepTimeMinutes" => 30,
        "cookTimeMinutes" => 0,
        "servings" => 6,
        "difficulty" => "Medium",
    ...
    [
        ...
        "instructions" => ["In a bowl, mix ground meat, grated onions, minced garlic, chopped parsley, and spices.", "Form the mixture into kebab shapes and grill until fully cooked.", "Serve the kebabs on flatbread with a drizzle of tahini sauce."],
        "prepTimeMinutes" => 25,
        "cookTimeMinutes" => 15,
        "servings" => 4,
        "difficulty" => "Easy",
    ...
    [
        ...
        "instructions" => ["In a blender, combine blueberries, banana, Greek yogurt, almond milk, and honey.", "Blend until smooth and creamy.", "Add chia seeds for extra nutrition and blend briefly.", "Pour into a glass and enjoy!"],
        "prepTimeMinutes" => 10,
        "cookTimeMinutes" => 0,
        "servings" => 1,
        "difficulty" => "Easy",
    ...
    [
        ...
        "instructions" => ["Grill or roast corn on the cob until kernels are charred.", "Brush each cob with mayonnaise, then sprinkle with crumbled Cotija cheese and chili powder.", "Serve with lime wedges."],
        "prepTimeMinutes" => 15,
        "cookTimeMinutes" => 15,
        "servings" => 4,
        "difficulty" => "Easy",
    ...
    [
        ...
        "instructions" => ["In a pot, sauté chopped onions and garlic until softened.", "Add shredded beets, cabbage, diced potatoes, grated carrots, and tomato paste.", "Pour in broth and add bay leaves. Simmer until vegetables are tender.", "Serve hot with a dollop of sour cream."],
        "prepTimeMinutes" => 30,
        "cookTimeMinutes" => 40,
        "servings" => 6,
        "difficulty" => "Medium",
    ...
    [
        ...
        "instructions" => ["In a pan, heat ghee and add mustard seeds, cumin seeds, and curry leaves.", "Add chopped onions, green chilies, and turmeric powder. Sauté until onions are golden brown.", "Mix in boiled and mashed potatoes.", "Spread dosa batter on a hot griddle. Place potato mixture in the center and fold."],
        "prepTimeMinutes" => 40,
        "cookTimeMinutes" => 20,
        "servings" => 4,
        "difficulty" => "Medium",
    ...
    [
        ...
        "instructions" => ["Warm falafel balls.", "Place falafel in the center of each wrap.", "Top with diced tomatoes, sliced cucumbers, red onions, shredded lettuce, and fresh parsley.", "Drizzle with tahini sauce and wrap tightly."],
        "prepTimeMinutes" => 15,
        "cookTimeMinutes" => 10,
        "servings" => 2,
        "difficulty" => "Easy",
    ...
    [
        ...
        "instructions" => ["In a glass, muddle lime wedges with granulated sugar.", "Fill the glass with ice cubes.", "Pour cachaça over the ice and stir well."],
        "prepTimeMinutes" => 5,
        "cookTimeMinutes" => 0,
        "servings" => 1,
        "difficulty" => "Easy",
